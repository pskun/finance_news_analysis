...
# 处理类型
PREPROCESS_TYPE_NEWS = 'news'
PREPROCESS_TYPE_GUBA = 'guba'
PREPROCESS_TYPE_GUBALIST = 'guba_list'
PREPROCESS_TYPE_REPORT = 'report'
PREPROCESS_TYPE_KEYWORD = 'keyword'

CRAWLER_TYPE_HANDLER_DICT = {
    PREPROCESS_TYPE_GUBALIST: 'GubaListPreprocessHandler',
    PREPROCESS_TYPE_NEWS: 'NewsPreprocessHandler',
}
